...
public class ItemControllerJpa {
    ...
    private ItemListJpa itemListJpa;


    private String localDate=LocalDate.now().toString();
    public ItemControllerJpa(ItemList itemList,ItemListJpa itemListJpa){
        this.itemList=itemList;
        this.itemListJpa=itemListJpa;
    }
    ...
    public String showExpense(ModelMap model){
       String username= getLoggedInUsername(model);
        List<Item> items= itemListJpa.findByUsername(username);
